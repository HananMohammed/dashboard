                ...
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <div class="main-card p-5 card">
                            ...
                            <form method="post" action="{{ route('dqrcode.store') }}" enctype="multipart/form-data" >
                                @csrf

                                <div class="custom-control custom-switch">
                                    <input type="checkbox" checked value="1" name="show" class="custom-control-input" id="switch1">
