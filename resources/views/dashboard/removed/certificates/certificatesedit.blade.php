    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title">{{trans('certificats.update')}}</h5>
                        <div class="main-card p-5 card">
                            <form method="post" action="{{ route('dcertificates.update',[$certificatesData->id]) }}"  enctype="multipart/form-data"  >
                                @csrf
                                                @method('put')
                                <div class="form-group">
                                    <label for="about_certificates_ar">{{trans('certificats.aboutCertificatesAr')}}</label>
                                    <textarea type="text"    name="about_certificates_ar" id="about_certificates_ar" class="form-control">{{$certificatesData->about_certificates_ar}}</textarea>
...
{{--                                                {{dd($errors->get('about_certificates_ar')[0])}}--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text"    name="about_certificates_en" id="about_certificates_en" class="form-control">{{$certificatesData->about_certificates_en}}</textarea>
                                    @if($errors->has('about_certificates_ar'))
                                        {{--                                                {{dd($errors->get('about_certificates_ar')[0])}}--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$certificatesData->alt_certificates_1}}"   name="alt_certificates_1" id="alt_certificates_1" class="form-control">
                                    @if($errors->has('about_certificates_ar'))
                                        {{--                                                {{dd($errors->get('about_certificates_ar')[0])}}--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$certificatesData->alt_certificates_2}}"   name="alt_certificates_2" id="alt_certificates_2" class="form-control">
                                    @if($errors->has('about_certificates_ar'))
                                        {{--                                                {{dd($errors->get('about_certificates_ar')[0])}}--}}
                                ...
                                <br>
                                <button class="btn btn-success" type="submit">{{trans('certificats.updateCertificates')}}</button>
