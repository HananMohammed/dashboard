            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">{{trans('partners.partners')}}</h5>
                        <div class="main-card p-5 card">
                            <form method="post" action="{{ route('dpartners.update',[$data->id]) }}" enctype="multipart/form-data" >
                                @csrf
                                @method('put')
                                ...
                                <br>
                                <button class="btn btn-success" type="submit">{{trans('partners.update')}}</button>
